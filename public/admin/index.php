...
<div class="admin-wrap"><div class="admin-nav"><div><h1 style="margin-bottom:4px">Painel de Agendamento</h1><span class="muted">Datas, horários, vagas e participantes</span></div><div class="actions"><a href="/admin/export.php">Exportar CSV</a><a href="/admin/logout.php">Sair</a></div></div>
